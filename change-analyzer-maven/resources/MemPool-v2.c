...
static Ohb_UInt16_t combineBlocks(const MemPool* const me, Ohb_UInt16_t n16Block1, Ohb_UInt16_t n16Block2) {
    ...
    n8NewSize = me->itsMemBlock[n16Buddy0].sHeader.n8Size + 1u;
    /* Sets the Header to indicate their new status */
    me->itsMemBlock[n16Buddy0].sHeader.n8Size = n8NewSize;
    me->itsMemBlock[n16Buddy1].sHeader.n8Size = n8NewSize;
