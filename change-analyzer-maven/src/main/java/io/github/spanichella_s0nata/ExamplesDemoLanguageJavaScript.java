 ...
 */
public class ExamplesDemoLanguageJavaScript {

  // https://www.programiz.com/javascript/examples
  private static String srcFilePathJavaScript = "resources/sampleFile1.js";
  private static String dstFilePathJavaScript = "resources/sampleFile2.js";
  ...
  public static void main(String[] args) {
    ...
    exampleParsingJavaScript(srcFilePathJavaScript);
    System.out.println("\nEXAMPLE 2: Getting the mappings between two trees:\n");
    exampleMappingJavaScript(srcFilePathJavaScript, dstFilePathJavaScript);
    System.out.println("\nEXAMPLE 3: Computing the actions between two trees:\n");
    exampleActionsJavaScript(srcFilePathJavaScript, dstFilePathJavaScript);
  }

  private static void exampleParsingJavaScript(String filePath) {
    try {
      ...
      TreeContext tc2 = new RhinoTreeGenerator().generateFrom().file(filePath);
      Tree t2 = tc2.getRoot(); // retrieves the root of the tree
      // OPTION 2+: can be a one-liner
      Tree t3 = new RhinoTreeGenerator().generateFrom().file(filePath).getRoot();
  ...
  private static void exampleMappingJavaScript(String srcFile, String dstFile) {
    // input data
    Tree src;
    Tree dst;
    try {
  ...
  private static void exampleActionsJavaScript(String srcFile, String dstFile) {
    // input data
    Tree src;
    Tree dst;
    try {
