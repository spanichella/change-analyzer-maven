 ...
 */
public class ExamplesDemoLanguageCpp {

  private static String srcFilePathCpp = "resources/cpp-class-v1.cpp";
  private static String dstFilePathCpp = "resources/cpp-class-v2.cpp";
  ...
  public static void main(String[] args) {
    ...
    exampleParsingC(srcFilePathCpp);
    System.out.println("\nEXAMPLE 2: Getting the mappings between two trees:\n");
    exampleMappingCpp(srcFilePathCpp, dstFilePathCpp);
    System.out.println("\nEXAMPLE 3: Computing the actions between two trees:\n");
    exampleActionsCpp(srcFilePathCpp, dstFilePathCpp);
  }
  ...
  private static void exampleParsingC(String filePath) {
    try {
      ...
      TreeContext tc2 = new SrcmlCppTreeGenerator().generateFrom().file(filePath);
      Tree t2 = tc2.getRoot(); // retrieves the root of the tree
      // OPTION 2+: can be a one-liner
      Tree t3 = new SrcmlCppTreeGenerator().generateFrom().file(filePath).getRoot();
  ...
  private static void exampleMappingCpp(String srcFile, String dstFile) {
    // input data
    Tree src;
    Tree dst;
    try {
  ...
  private static void exampleActionsCpp(String srcFile, String dstFile) {
    // input data
    Tree src;
    Tree dst;
    try {
